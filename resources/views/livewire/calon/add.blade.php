        ...
        <div class="mb-4">
            ...
            <div class="flex flex-wrap">
                ...
                <div class="w-1/2 mb-4 p-2">
                    ...
                    <input type="text" placeholder="Pekerjaan" name="pekerjaan" id="pekerjaan" wire:model='pekerjaan' class="rounded-lg w-full focus:ring-indigo-500 focus:ring-inset ring-1 ring-slate-300 focus:ring-2 border-0">
