<div class="p-5">
    <h3 class="font-semibold text-md">Edit Calon Kepala Desa</h3>
    <hr class="mb-4">
        ...
        <div class="mb-4">
            <div class="flex flex-wrap">
                ...
                <div class="w-1/2 mb-4 p-2">
                    ...
                    <input type="text" class="rounded-lg w-full focus:ring-indigo-500 focus:ring-inset ring-1 read-only:bg-slate-100 ring-slate-300 focus:ring-2 border-0" wire:model.defer="tahunPemilihan" id="tahunPemilihan" readonly>
